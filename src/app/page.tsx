  ...
  return (
    <main className="min-h-screen bg-slate-50 dark:bg-[#0a0f1e] flex flex-col antialiased text-slate-900 dark:text-white transition-colors duration-300">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute top-[-10%] left-1/4 w-[1000px] h-[1000px] rounded-full bg-sky-400/[0.03] dark:bg-sky-400/[0.04] blur-[160px] animate-pulse-glow" />
        <div className="absolute bottom-1/4 right-1/4 w-[800px] h-[800px] rounded-full bg-amber-400/[0.03] dark:bg-amber-400/[0.04] blur-[140px] animate-pulse-glow" style={{ animationDelay: '2s' }} />
        <div className="absolute top-1/2 left-[-10%] w-[600px] h-[600px] rounded-full bg-purple-400/[0.02] dark:bg-purple-400/[0.03] blur-[120px]" />
      </div>
